...
namespace Cron\Unilevel_Flushout;
 ...
 * @since version
 */
function unilevel_users()
{
	return fetch_all(
		'SELECT * ' .
		'FROM network_unilevel ul ' .
 ...
 * @since version
 */
function update_unilevel($id)
{
	crud('UPDATE network_unilevel ' .
...
{
	$max_daily_income = settings('unilevel')->{$account_type . '_max_daily_income'};
