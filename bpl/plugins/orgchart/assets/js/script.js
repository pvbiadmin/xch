// var params = {
//     selector: "#svgChart",
//     dataLoadUrl: "http://localhost/genealogy/assets/data.json",
...
//             /*var*/
//             new_x = (-x + (window.innerWidth / 2));
//             /*var*/
//             new_y = (-y + (window.innerHeight / 2));
//
...
//             //strVar += "    <!--";
//             //strVar += "    <div class=\"tooltip-image-wrapper\"> <img width=\"300\" src=\"http://localhost/genealogy/assets/images/general.jpg\" alt=\"\"> <\/div>";
//             //strVar += "-->";
...
//             strVar += "     <button class='btn btn-tooltip-department' onclick='window.location.href=\"https://www.google.com/\"'>Add Member</button>";
...
//             //strVar += "        ";
//             //strVar += "        <\/span>           <ul class=\"tags\">" + getTagsFromCommaSeparatedStrings(item.tags) + "<\/ul><\/h4>";
//             strVar += "<br><br><br><br><br>";
//             strVar += "<\/div>";
...
//             strVar += "              <img class=\"image\" src=\"" + result.imageUrl + "\"\ alt=\"\">";
//             strVar += "            <\/div>";
