...
namespace BPL\Jumi\Request_Loan_Confirmed;
	...
	if (!empty($result))
	{
		...
		foreach ($result as $member)
		{
			$str .= '<tr>
                ...
                <td>' . number_format($member->loans, 2) . ' ' . /*$efund_name .*/
				'</td>
...
function view_request_confirmed($usertype, $user_id): string
{
	...
	$str .= '<h1> ' . settings('ancillaries')->loan_fund_name . ' Transactions</h1>';
