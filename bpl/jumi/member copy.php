			...
			if ($username === '') {
				...
				if (!empty($login)) {
					if ((int) $login->block === 0) {
						...
						$errorMessage = 'Your account has been disabled by an Admin. Contact support for more info.';
						$app->redirect(
							Uri::root(true) . '/' . sef(43), // Redirect to the login page
