<?php
//
//namespace BPL\Cron\Leadership\Fast_Track;
//
...
//			{
//				$bonus = bonus_total_leadership_fast_track($user->user_id)['bonus'];
//
...
// * @since version
// */
//function level_leadership_fast_track(array $head = []): array
//{
//	$group   = [];
//	$passive = [];
//
...
//	for ($i_i = 2; $i_i <= $n; $i_i++)
//	{
//		$result[] = level_leadership_fast_track(array_reverse($result)[0][0]);
//	}
//
...
// * @since version
// */
//function get_leadership_fast_track($indirect, $share, $share_cut)
//{
//	$leadership = 0;
//
//	if ($indirect)
...
// * @since version
// */
//function bonus_total_leadership_fast_track($user_id): array
//{
//	$level_1 = level_leadership_fast_track([$user_id]);
//
...
//	$bonus  = get_leadership_fast_track(
//		$level_1[1],
