...
namespace BPL\Ajax\Mods\Check_Input4;
...
function main($uid)
{
	...
	echo $result ? ('<a style="margin-top:-7px;" href="' . sef(67) . qs() . 'uid=' .
		$result->id . '" class="uk-button uk-button-primary">Check Codes Inventory</a>') :
