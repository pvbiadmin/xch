...
namespace BPL\Ajax\Ajaxer\Genealogy_test;
        ...
        class TreeVisualization {
            ...
            */
            ...
            createNodes(node, source) {
                ...
                // Add diamond shape for nodes
                nodeEnter.append("path")
                    .attr("class", "node")
                    .attr("d", d3.symbol().type(d3.symbolDiamond).size(200)) // Adjust size as needed
                    .style("fill", d => d._children ? "lightsteelblue" : "#fff");
            ...
            */
            ...
            removeNodes(node, source) {
                ...
                nodeExit.select("path")
                    .attr("d", d3.symbol().type(d3.symbolDiamond).size(1e-6));
