...
namespace BPL\Ajax\Ajaxer\Token\Trade\Buy\Amount;
...
{
	// token amount buy trade ajax validation
	$str = '<script>';
	$str .= '(function ($) {
            ...
            $(document).ready(function () {
                ...
                $("#amount_buy_trade").bindWithDelay("keyup", function () {
                    var data = {
                        "action": "amount_buy_trade",
                        "amount": $(this).val(),
                        "price": $("#price_buy_trade").val(),
                        "user_id": ' . $user_id .
					'}
