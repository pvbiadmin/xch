		...
		<div id="tm-middle" class="tm-middle uk-grid" data-uk-grid-match data-uk-grid-margin>
			...
			<div class="<?php echo $columns['main']['class'] ?>">
				...
				<?php if ($this['config']->get('system_output', true)) : ?>
					...
					function session_get_th($name, string $default = '')
					{
					...
					$user_id = session_get_th('user_id');
//					$marginLeft = !$user_id  ? '0px' : '250px';
					$paddingTop = !$user_id ? '100px' : '200px';
					?>

                    <main id="tm-content" class="tm-content" style="padding-top: <?php echo $paddingTop; ?>;">
